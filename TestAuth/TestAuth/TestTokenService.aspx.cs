...
namespace TestAuth
{
    public partial class TestTokenService : System.Web.UI.Page
    {
        /// <summary>
        /// loginSuccessURL
        /// </summary>        
        private static string authTransferURL = HttpContext.Current.Request.Url.Scheme + ":" + "//" + HttpContext.Current.Request.Url.Host + ":" + HttpContext.Current.Request.Url.Port + "/Welcome.aspx";
       ...
       // private static string authURL = string.Format("https://hdfc-accounts-api.skill-mine.com/authz-srv/authz?response_type=token&response_mode=query&scope=openid%20profile%20email%20phone&redirect_uri={0}&flow_id=80b9f3e9-ebd8-4925-ab23-ef3517577112&client_id=c748b0bb-3238-4338-ae76-0b9716f70202", authTransferURL);
        ...
        /// <summary>
        /// btnRedirecttoAuth_Click
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnRedirecttoAuth_Click(object sender, EventArgs e)
        {
            try
            {
